...
//                                 // height = 75;
//                                 let difference = Number(apiToTimeStart) - Number(apiFromTimeStart);
//                                 let height = Math.round(((Number(apiToTimeStart) - Number(apiFromTimeStart)) * totalColumnHeight) - (Number(apiFromTimeEnd) * 2.5));                              
